 ...
 <script type="text/javascript">
  ...
  function checkForm(form)
  {
    if(form.username.value == "") {
      alert("Error: IC number cannot be blank!");
      form.username.focus();
      return false;
    }
    re = /^\w+$/;
...
<BR>IC Number :<BR> 
<input type="text"  id="username" name="username" placeholder="9211026018922" onkeypress="return isNumberKey(event)" maxlength="12"> <BR>  
<?php
...
echo "</div>";
 ?>  
<BR>Password :<BR> 
<input type="password" id="password" name="pwd1" placeholder="********" > <BR>
<BR>Re-enter Password:<BR> 
<input type="password" id="password" name="pwd2" placeholder="********"  > <BR>
<BR>Email:<BR> 
<input type="email" id="email" name="email" placeholder="alisham@gmail.com"  > 
...
<BR>Phone Number : <BR> <input name="phone"  id="phone" maxlength="11" onkeypress="return isNumberKey(event)" type="text" value="" placeholder="01110687821"> <BR>
...
<BR>Phone Number : <BR> <input name="phonew"  id="phonew" maxlength="11" onkeypress="return isNumberKey(event)" type="text" value="" placeholder="01110687821"> <BR>
...
<BR>  If Yes, please state the name of co-operative :<BR> <input type="text" name="statename" id="statename" onblur="myFunction()">
