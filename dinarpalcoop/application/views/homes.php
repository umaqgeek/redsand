...
?>
    ...
    <h2>Welocome to Portal DinarPal Co-Operative </h2>
  ...
  <?php echo "<BR>Welcome, <b id='welcome'><i>" . $firstname . " ". $middlename . " ". $lastname . "</i></b><BR><BR>"; ?>    
                                         <?php 
										   if($userlevel=='0') 
										     ...
										     echo "Your as <B>DinarPal Co-Operative Member</B><BR><BR>"; 
...
Status :  
                                     <?php 
										   if($active=='Active') 
										     ...
										     echo "<B style='color:#3a87ad;'>In Progress</B>";
...
<BR>
<img src="<?php echo base_url(); ?>assets/images/dinarpalcoop.jpg" width="200px" height="200px" style="border-radius:5px;"/>
