...
<BR><BR>
	...
	<div id="content" class="clearfix">
				...
				<h1 class="page-title" itemprop="name">Hubungi Kami</h1>
				<h4>Jika ada sebarang pertanyaan atau sebarang kemusykilan anda bolehlah terus berhubunga dengan kami.</h4> <BR>
			<!-- /page-title -->

			<div class="page-content entry-content" itemprop="articleBody">
			
				<div class="shortcode col3-2 first">
<script type="text/javascript">	
						jQuery(document).ready(function() {
					  		ThemifyMap.initialize( "Yonge St. and Eglinton Ave, Toronto, Ontario, Canada", 4089, 15, "ROADMAP", "yes", "yes" );
						});
					</script>
...
<BR><BR>
<a href="<?php echo base_url(); ?>user_authentication/user_registration_show"><B>Sertai Kami Sekarang</B></a>
<BR><BR>
</div> 
