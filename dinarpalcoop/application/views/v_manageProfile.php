...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no">
  ...
  function checkForm(form)
  {
	...
	if(confirm ( "Are you sure want to update profail information?"))
	  {  
	     alert(" Profail information updated succesfully ");
	     return true;
	  }
	 else
	 { 
...
<?php echo form_open("user_authentication/updateProfileProcess/" . $id,$attributes); ?> 
