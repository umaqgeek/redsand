...
<input type="text" name="username" id="username" placeholder="9211026018922" onkeypress="return isNumberKey(event)" maxlength="12"required /> <BR><BR>
Password  : <BR>
<input type="password" name="password" id="password" placeholder="********"  required /> <BR><BR>
 ...
 <?php echo anchor('main/forgotPassword','Forgot Password?'); ?> &nbsp;&nbsp;&nbsp;
  <?php echo anchor('main/registerPage','User Manual'); ?>
<BR><BR>
</div>
