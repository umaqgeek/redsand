...
class Main extends CI_Controller 
{
	...
	public function overview()  {$this->_redirectPage("overview");}
	...
	public function joins()     {$this->_redirectPage("joins");}
        public function share()     {$this->_redirectPage("membershare");}
        public function audit()     {$this->_redirectPage("intrnalaudit");}
        public function syariah()   {$this->_redirectPage("syariah");}
        public function faq()       {$this->_redirectPage("faq");}
        public function compliances()       {$this->_redirectPage("compliances");}
...
function menuLevel()
 {
	 ...
	 if($data != false)
	 {
		 ...
		 <header id="header" class="pagewidth">
			...
			<hgroup>
<div id="site-logo"><a href="'. base_url() .'main" title="">
<span><img src="'. base_url() .'assets/images/kodinar.png" width="85" height="12" alt="logo" style="margin-top: -26px;"/></span></a></div>			
    ...
    ';
		 ...
		 switch ($lvl){
			case '0' : 
			case '1' : 	$code = $code . '
			  <li class="page_item page-item-171"> <a href="'. base_url() .'main/user/2"><B>OVERVIEW</B></a></li> 
			 <li class="page_item page-item-409 page_item_has_children"><a href="'. base_url() .'main/user/9"><B>PROFILE</B></a>
     <ul class="children">
     <li class="page_item page-item-1096"><a href="'. base_url() .'main/user/6">View Account</a></li>
     ...
     <li class="page_item page-item-409 page_item_has_children"><a href="'. base_url() .'main/user/9"><B>INBOX</B></a>
     <ul class="children">
     <li class="page_item page-item-1096"><a href="'. base_url() .'c_mail">
     ...
     <li class="page_item page-item-409 page_item_has_children"><a href="'. base_url() .'main/user/9"><B>PAYMENT</B></a>
     <ul class="children">
     <li class="page_item page-item-1096"><a href="'. base_url() .'gallery/index">Upload File</a></li>
     <li class="page_item page-item-1096"><a href="'. base_url() .'main/user/13">View File</a></li>
     </ul>
     </li>     
    ...
    <!-- <li class="page_item page-item-1096"><a href="'. base_url() .'main/user/2">Summary All Member</a></li> -->
     ...
     <ul class="children">
     <li class="page_item page-item-1096"><a href="'. base_url() .'gallery/index">Upload File</a></li>
     <li class="page_item page-item-1096"><a href="'. base_url() .'main/user/14">View File</a></li>
     </ul>
     </li>     
...
<link href="'. base_url().'assets/css/button.css" rel="stylesheet" width="80px" /><button type="submit" style="margin-top: -3px;" class="button" data-toggle="modal">Log Out</button></a></li>
	 ...
	 else
	 {
		$code = '<header id="header" class="pagewidth">
			...
			<hgroup>
				<div id="site-logo"><a href="'. base_url() .'main"><span><img src="'. base_url() .'assets/images/kodinar.png" width="84" height="12" alt="logo" style="margin-top: -26px;"/></span></a></div>			</hgroup>
			...
			<nav id="main-nav-wrap">
                ...
                <ul class="children">
                 <li class="page_item page-item-1099"><a href="'. base_url() .'main/overview">Corporate Overview</a></li>
                 ...
                 <li class="page_item page-item-1099"><a href="'. base_url() .'main/share">Member Share</a></li>
                 <li class="page_item page-item-1099"><a href="'. base_url() .'main/compliances">Compliances</a></li>
                 <li class="page_item page-item-1099"><a href="'. base_url() .'main/faq">FAQs</a></li>
                </ul>
                </li>
...
<li><a href="'. base_url() .'main/loginPage"><link href="'. base_url().'assets/css/button.css" rel="stylesheet" /><button type="submit" style="margin-top: -3px;" class="button" data-toggle="modal">Log In</button></a></li>
<li><a href="'. base_url() .'main/registerPage"><link href="'. base_url().'assets/css/button.css" rel="stylesheet"  /><button type="submit" class="blue-button" data-toggle="modal">Create Account</button></a></li>
