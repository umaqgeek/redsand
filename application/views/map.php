...
<BR><BR>
	...
	<div id="content" class="clearfix">
				...
				<h4>If you have any questions or concerns you can keep in touch with us .</h4> <BR>
			<!-- /page-title -->

			<div class="page-content entry-content" itemprop="articleBody">
			
				<div class="shortcode col3-2 first" style="width:75%">
<script type="text/javascript">	
						jQuery(document).ready(function() {
					ThemifyMap.initialize( "Inkubator K-ekonomi Jalan Business City Bandar Mitc 75450 Ayer Keroh Melaka", 4089, 15, "ROADMAP", "yes", "yes" );
						});
					</script>
					<div class="shortcode map">
						<div id="themify_map_canvas_4089" style="display: block;width:100%;height:600px;" class="map-container">&nbsp;</div>
					</div>
</div>
<div class="shortcode col3-1" style="width:20%">
<h3>Social Media</h3>
<p>
<A href="https://www.facebook.com/dinarpal" > <img src="<?php echo base_url(); ?>assets/images/facebook.png" /></A>
<img src="<?php echo base_url(); ?>assets/images/twitter.png" />
<img src="<?php echo base_url(); ?>assets/images/pinterest.png" />
</p>
<h3>Address</h3>
<p>Suite 15 MITC<br />
...
<h3>Email</h3>
<p>admin@dinarpal.coop</p>
<h3>Phone</h3>
<p>+60 112 222 8069</p>
<h3>Hours</h3>
<p>Mon &#8211; Fri : 11:00am &#8211; 10:00pm<br />
Sat : 11:00am &#8211; 2:00pm<br />
Sun : 12:00am &#8211; 11:00pm<br />
</p>
<BR><BR>
<!-- <a href="<?php echo base_url(); ?>main/registerPage"><B>Join Us Now</B></a> -->
<B>
<?php echo anchor('main/map', 'Join Us Now', array('onclick' => "return alert('Sorry, We are upgrading the system')")); ?>
</B>
