...
<table>
  <tbody>
    ...
    <?php foreach($result as $key=>$v) {?>
        <tr class="">
        	<!--<td><?php echo $id =  $v['id_login']?></td>
	        <td><?php echo $v['status']?></td>-->
	        <td><?php echo $v['firstname']?></td>
	        <td><?php echo $v['lastname']?></td>
	        <!--<td><?php echo $v['gender']?></td>-->
	        <td><?php echo $v['state'];?></td>
	        <td> <a href="<?php echo site_url('pag/view/'.$id); ?>">View</a>|<a href="<?php echo site_url('pag/edit/'.$id); ?>">Edit</a>|<a href="<?php echo site_url('pag/delete/'.$id); ?>" onclick="return confirm('Do you really want to delete this file?')">Remove</a></td>
       </tr>
      <?php }?>
  </tbody>
</table>
