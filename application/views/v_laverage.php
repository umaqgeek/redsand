...
<BR>Dividen :<BR> 
<input type="text" id="dividen" name="dividen"  value="<?php echo $dividen ?>" disabled > <BR><BR>

</div>
<div class="shortcode col3-1"  style="width:30%;">
<BR>
Share Bonus :<BR> 
<input type="text" id="share" name="share" value="<?php echo $bonus ?>"  disabled   > <BR><BR>
</div>

<div class="shortcode col3-1"  style="width:30%;">

<BR>Profit Sharing :<BR> 
<input type="text" id="bonus" name="bonus" value="<?php echo $profit ?>"  disabled >  
