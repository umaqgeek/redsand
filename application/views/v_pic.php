...
<table border=1 style="width:100%">
    ...
    <?php {?>
      ...
      <tr>       
        <td><center>    <?php echo $pic->reference;         ?>   </td>
        <td><center>    <?php echo $pic->date;         		?>   </td>
        <td><center>    <?php echo $pic->status;         	?>   </td>
        <td><center>    <?php echo $pic->fee;         	?>   </td>
        <td><center>    <?php echo $pic->available;         	?>   </td>
        <td><center>    <?php echo $pic->source;       		?>   </td>      
       </tr>  
...
<!--<table border=1 style="width:100%">
    ...
    <?php 
	 	foreach($result as $data){?>
   		<tr>       
		   	<td><center>    <?php echo $data->reference;     		?>   </td>
		    	<td><center>    <?php echo $data->date;  	  		?>   </td>
		    	<td><center>    <?php echo $data->status;       ?>   </td> 
		    	<td><center>    <?php echo $data->fee;       ?>   </td>
		    	<td><center>    <?php echo $data->available;       ?>   </td>
		    	<td><center>    <?php echo $data->source;       ?>   </td>
