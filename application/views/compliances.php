...
<div class="shortcode col3-1tt">


    <div class="shortcode col3-1" style="width:400px;">
    <BR>
  	    <h4>Certificate of registration of Koperasi DinarPal Melaka Berhad from (SKM)</h4>
  
    <BR>
        <center><img src="<?php echo base_url(); ?>assets/images/compliances/Perakuan Pendaftaran Koperasi.jpg" width="400" height="500"/></center>
    <BR>
    ...
    <div class="shortcode col3-1" style="width:400px;">
    <BR>
        <h4>Certificate of membersip with National Cooperative Organisation of Malaysia Berhad (ANGKASA) </h4>
    </br>
        <center><img src="<?php echo base_url(); ?>assets/images/compliances/Sijil Angkasa-page-001.jpg" width="400" height="500"/></center>
    <BR>
    ...
    <div class="shortcode col3-1" style="width:400px;">
    <BR>
        <h4>Ar-Rahnu approval form Cooperative Commission of Malaysia (SKM) </h4>

    <BR>
        <center><img src="<?php echo base_url(); ?>assets/images/compliances/Surat Kelulusan SKM Ar-Rahnu DinarPal-page-001.jpg" width="400" height="500"/></center>
    <BR>
    ...
    <BR>
        <center><img src="<?php echo base_url(); ?>assets/images/compliances/Surat Kelulusan SKM membuka cawangan DinarPal-page-001.jpg" width="400" height="500"/></center>
    <BR>
