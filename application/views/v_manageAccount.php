...
<B>
<BR> Name :<BR>
<input type="text" id="firstname" name="firstname" placeholder="First name" value="<?php echo $firstname ?>"  onblur="myFunction()"><BR><BR>
...
<BR>Phone Number : <BR> <input name="phone"  id="phone" placeholder="Please enter your phone number. Eg: 0123456789" maxlength="10" onkeypress="return isNumberKey(event)" type="text" value="<?php echo $phone ?>" > <BR>


<BR>Facebook URL ID : <BR> <input type="text" id="facebookurlid" name="facebookurlid" placeholder="Please enter your Facebook URL ID. Eg: https://www.facebook.com/xxxxxxx77" value="<?php echo $facebookurlid ?>"> <BR>

<BR>Date of birth : <BR> <input type="date" id="date" name="date"  value="<?php echo $date ?>" onChange="(this.type='date')"><BR><BR>

Address: <BR>
<input type="text" id="street1" name="street1" placeholder="Street 1. Eg: NO.55" value="<?php echo $street1 ?>" onblur="myFunction()" >  <BR><BR>
<input type="text" id="street2" name="street2" placeholder="Street 2. Eg: JALAN MAHKOTA" value="<?php echo $street2 ?>" onblur="myFunction()">  <BR><BR>
<input type="text" id="district" name="district" placeholder="District. Eg: ALOR GAJAH" value="<?php echo $district ?>" onblur="myFunction()">  <BR><BR>
<input name="postcode" maxlength="5" size="7" type="text" id="postcode" name="postcode" placeholder="Postcode. Eg: 12345" value="<?php echo $postcode ?>" onkeypress="return isNumberKey(event)" ><BR><BR>
<input type="text" id="state" name="state" placeholder="State. Eg: MELAKA" value="<?php echo $state ?>" onblur="myFunction()" >  <BR><BR>
<input name="country" id="country" type="text" placeholder="Country. Eg: MALAYSIA" value="<?php echo $country ?>"  onblur="myFunction()"/> <BR><BR><BR><BR>
...
<B>
<BR> Name :<BR> 
<input type="text" id="firstnamew" name="firstnamew" placeholder="Please enter your father/mother/husband/wife First Name" value="<?php echo $firstnamew ?>" onblur="myFunction()" > <BR><BR>
<input type="text" id="middlenamew" name="middlenamew" placeholder="Please enter your father/mother/husband/wife Middle Name" value="<?php echo $middlenamew ?>" onblur="myFunction()"> <BR><BR>
<input type="text" id="lastnamew" name="lastnamew" placeholder="Please enter your father/mother/husband/wife Last Name" value="<?php echo $lastnamew ?>" onblur="myFunction()">  <BR>

<BR>IC Number : <BR> <input type="text" id="icnumberw" maxlength="12" name="icnumberw" placeholder="Please enter your father/mother/husband/wife IC Number. Eg: 911028017283" onkeypress="return isNumberKey(event)" value="<?php echo $icnumberw ?>" > <BR><BR>
         <?php
		   			$male_status = 'unchecked';
           			$female_status = 'unchecked';
...
<BR>Phone Number : <BR> <input name="phonew"  id="phonew" placeholder="Please enter your father/mother/husband/wife Phone Number. Eg: 0123456789" maxlength="10" onkeypress="return isNumberKey(event)" type="text" value="<?php echo $phonew ?>"> <BR>

<BR>Email : <BR> <input name="emailw"  id="emailw" type="email" placeholder="Please enter your father/mother/husband/wife Email Addess. Eg: xxxxxx@xxxx.com" value="<?php echo $emailw ?>"> <BR>

<BR>Facebook URL ID : <BR> <input type="text" id="facebookurlidw" name="facebookurlidw" placeholder="Please enter your father/mother/husband/wife Facebook URL ID. Eg: https://www.facebook.com/xxxxxxx77"value="<?php echo $facebookurlidw ?>"> <BR>

<BR>Date of birth : <BR> <input type="date" id="datew" name="datew"  value="<?php echo $datew ?>" onChange="(this.type='date')"> <BR><BR>

Address: <BR>
<input type="text" id="street1w" name="street1w" placeholder="Please enter your father/mother/husband/wife Address. Street 1. Eg: N0.99" value="<?php echo $street1w ?>" onblur="myFunction()">  <BR><BR>
<input type="text" id="street2w" name="street2w" placeholder="Street 2. Eg: JALAN CEMPAKA 2" value="<?php echo $street2w ?>" onblur="myFunction()">  <BR><BR>
<input type="text" id="districtw" name="districtw" placeholder="District. Eg: MUAR" value="<?php echo $districtw ?>" onblur="myFunction()">  <BR><BR>
<input name="postcodew" maxlength="5" type="text" id="postcodew" placeholder="Postcode. Eg: 12345" onkeypress="return isNumberKey(event)" value="<?php echo $postcodew ?>" ><BR><BR>
<input type="text" id="statew" name="statew" placeholder="State. Eg: JOHOR" value="<?php echo $statew ?>" onblur="myFunction()">  <BR><BR>
<input name="countryw" id="countryw" type="text" placeholder="Country. Eg: MALAYSIA" value="<?php echo $countryw ?>" onblur="myFunction()" /> <BR><BR><BR><BR>
...
<link href="<?php echo base_url().'assets/css/button.css' ?>" rel="stylesheet"><button type="reset" class="button " data-toggle="modal" name="Reset">Reset</button></link>
<?php 
echo form_close();
?>    
 <BR><BR><BR>       
