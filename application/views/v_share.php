...
<?php echo form_open('user_authentication/manageAccount',$attributes); ?> 


<div class="shortcode col3-1" style="width:30%;">
<BR>Entering Fee :<BR> 
<input type="text" id="fee" name="fee" value="<?php echo $fee ?>" disabled > <BR><BR>

</div>
<div class="shortcode col3-1" style="width:30%;">
<BR>Available Share (MYR) :<BR> 
<input type="text" id="available" name="available"  value="<?php echo $available ?>" disabled > <BR><BR>
</div>

<div class="shortcode col3-1" style="width:30%;">

<BR>Available Share (Gram) :<BR> 
<input type="text" id="history" name="history" value="<?php echo $history ?>" disabled >  
