...
<?php endforeach; ?>
 ...
 <p class = "infoD" align ="right">
    <?php echo "<a href = '".site_url("portal/deleteAll")."' onclick = 'return confirm(".'"'."Are you sure want to delete all post".'"'.");'><button>Delete All</button></a>";?></p>
