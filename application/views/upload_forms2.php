...
<?php
		...
		Date<BR> <input type="date" name="dates" ><BR><BR>

		<input type="text" name="statuses" value="Progress" hidden>
		Source File<BR><input type="file" name="source" ><BR>
		...
		<ul>
  		...
  		<link href="<?php echo base_url().'assets/css/button.css' ?>" rel="stylesheet"><button type="submit" class="button " data-toggle="modal" value="Upload File">Upload</button></link>
