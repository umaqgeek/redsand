...
<!--open baris ke 1-->
    ...
    <div class="shortcode col3-1" style=" margin-top:1cm; background-color:#FFF; border-radius:50px; height:0px; padding-bottom: 100px; box-shadow: 2px 2px 4px  #fff; ">

<h5 style="text-align:center; color:#fff;"> NAME </h5> <HR style=" border:2px solid #fff;">
...
<h6 style="text-align:center;"> Encik Abdul Rahman Bin Taiyun </h6> <HR style=" border:2px solid #CCC;">
...
<div id="themify_builder_content-161" data-postid="161" class="themify_builder_content themify_builder_content-161 themify_builder themify_builder_front">
  ...
  <div class="shortcode col3-1" style=" margin-top:2.5cm; background-color: #FFF; border-radius:50px; height:0px; padding-bottom: 100px; box-shadow: 2px 2px 2px  #000000; ">
    ...
    <img src="<?php echo base_url(); ?>assets/images/personal.jpg"  style="border-radius:50%; width:100px; height:100px; float:right;"/>
<h6 style="text-align:center;"> Puan Siti Hajar Binti Sharif </h6> <HR style=" border:2px solid #CCC;">
<p align="justify"  style="text-align:center;"> Committee member </p> <BR>
</div>
<div id="themify_builder_content-161" data-postid="161" class="themify_builder_content themify_builder_content-161 themify_builder themify_builder_front">
	</div>
...
<div class="shortcode col3-1" style=" margin-top:2.5cm; background-color: #FFF; border-radius:50px; height:0px; padding-bottom: 100px; box-shadow: 2px 2px 2px  #000000;" >
   ...
   <img src="<?php echo base_url(); ?>assets/images/personal.jpg"  style="border-radius:50%; width:100px; height:100px; float:right;"/>
<h6 style="text-align:center;"> Raja Puteri Shafiqkin Binti Raja Mokhtar </h6> <HR style=" border:2px solid #CCC;">
<p align="justify" style="text-align:center;"> Committee member </p> <BR>
</div>
...
<!--<div class="shortcode col3-1" style=" margin-top:2.5cm; background-color: #FFF; border-radius:50px; height:0px; padding-bottom: 100px; box-shadow: 2px 2px 2px  #000000;">
    ...
    <img src="<?php echo base_url(); ?>assets/images/personal.jpg"  style="border-radius:50%; width:100px; height:100px; float:right;"/>
<h5 style="text-align:center;"> NAME </h5> <HR style=" border:2px solid #CCC;">
<p align="justify" style="text-align:center;">Finance Manager</p> <BR>
</div>-->
