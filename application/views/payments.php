...
<title>Dinarpal Coop member</title>
...
<BR>
<form action="<?php echo site_url('gallery/upload_pic'); ?>" method="post" enctype="multipart/form-data">
...
<?php
		...
		Recipient Reference <BR> <input type="text" name="reference" placeholder="Please enter reference for recipient. Eg: Fee Payment"><BR><BR>
		Date<BR> <input type="text" id="datepicker" name="dates" ><BR><BR>

		<input type="text" name="statuses" value="Progress" hidden>
                
                <?php if ($isPayFee == false) { ?>
...
<script>
  $(function() {
    $( "#datepicker" ).datepicker({
		...
		<ul>
			<li><h6>File must not exceed 120KB)</h6></li>
			<li><h6>On this page you can only use JPG JPEG JPE PNG BMP GIF TIF TIFF image formats.</h6></li>
		</ul><BR>
 
  		<link href="<?php echo base_url().'assets/css/button.css' ?>" rel="stylesheet"><button type="submit" class="button " data-toggle="modal" value="Upload File">Upload</button></link><!--<input type="submit" value="Upload File">-->
